...
- [ ] **ADP-101**: Basalam OAuth/token refresh و مدیریت انقضا.
- [ ] **ADP-102**: Basalam catalog و variation با batch update.
- [ ] **ADP-103**: Basalam vendor parcel/order و وضعیت ارسال.
- [ ] **ADP-104**: Basalam chat/review/file و rate limit.
- [ ] **ADP-105**: contract fixture برای Digikala و Torob، بدون coupling به Basalam.
- [ ] **ADP-106**: mapping خطاهای HTTP provider به خطای موقت/دائمی داخلی. پایه HTTP مشترک و adapterهای قابل تزریق اضافه شدند؛ پیاده‌سازی endpoint واقعی باقی‌مانده.
