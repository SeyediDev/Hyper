...
public sealed class BasalamOAuthSettings
{
    ...
    public string ProfileEndpoint { get; set; } = "https://openapi.basalam.com/v1/users/me";
    ...
    IDataProtectionProvider protection)
{
    ...
    private async Task<BasalamTokenResponse> SendTokenAsync(Dictionary<string, string> values, CancellationToken ct)
    {
        ...
        {
            // Keep the existing, verified panel OAuth flow: the token endpoint accepts
            // the form-encoded authorization-code exchange used by this integration.
