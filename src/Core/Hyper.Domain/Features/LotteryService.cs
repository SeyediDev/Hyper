...
using Lottery = Hyper.Domain.Entities.Lotteries.Lottery;
using LotteryParticipant = Hyper.Domain.Entities.Lotteries.LotteryParticipant;
using LotteryReward = Hyper.Domain.Entities.Lotteries.LotteryReward;
