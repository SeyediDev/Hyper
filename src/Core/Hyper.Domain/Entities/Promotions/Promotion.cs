...
public class Promotion : HyperBaseCoreConfigAuditableEntity<int>, ISubOfTenant
{
    ...
    [SBVR(SBVRModality.Permitted, "نمایش کمپین در پرتال", "این فیلد تعیین می‌کند که آیا این کمپین در پرتال هایپریک برای مشتریان قابل نمایش است یا خیر. مشتریان می‌توانند از کمپین‌های قابل نمایش مطلع شوند و از نحوه امتیازگیری و اقدامات لازم آگاه شوند.")]
