namespace Hyper.Domain.Entities.Promotions.Plans;
...
public class Plan : HyperBaseCoreAuditableEntity<int>, ISubOfPromotion
{
    ...
    [SBVR(SBVRModality.Permitted, "دسترسی محدود", "جامعه/بازار برای محدود کردن دسترسی طرح به گروه‌های خاص مشتریان استفاده می‌شود")]
