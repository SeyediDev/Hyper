...
/// <summary>
/// عضویت مشتری در پویش - ردیابی وضعیت شرکت هر مشتری در یک پویش
/// </summary>
[DisplayName("عضویت مشتری در پویش")]
[SBVR(SBVRModality.Obligatory, "ردیابی شرکت", "هر عضویت مشتری در پویش باید برای مدیریت وضعیت و محدودیت‌های شرکت قابل شناسایی باشد")]
