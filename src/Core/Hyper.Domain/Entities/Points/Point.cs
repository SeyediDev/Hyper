...
| CustomerPoint.{Key}.LevelId | سطح، سطح مشتری در امتیاز با این کلید  | CustomerPoint.Momtaz.LevelId | 3                     |")]
    ...
    [SBVR(SBVRModality.Permitted, "افزایش سر زدن به صفحه باشگاه", "بعضی از امتیازها لازم است کاربر حتما به صفحه هایپریک سر بزند و بگوید که این امتیاز را دیده تا به صورت واقعی آن را کسب کند.")]
