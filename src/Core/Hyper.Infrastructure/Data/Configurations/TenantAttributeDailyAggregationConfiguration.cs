...
public class TenantAttributeDailyAggregationConfiguration : IEntityTypeConfiguration<TenantAttributeDailyAggregation>
{
    public void Configure(EntityTypeBuilder<TenantAttributeDailyAggregation> builder)
    {
