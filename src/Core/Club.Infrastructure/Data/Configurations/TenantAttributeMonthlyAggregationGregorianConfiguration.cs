...
public class TenantAttributeMonthlyAggregationGregorianConfiguration : IEntityTypeConfiguration<TenantAttributeMonthlyAggregationGregorian>
{
    public void Configure(EntityTypeBuilder<TenantAttributeMonthlyAggregationGregorian> builder)
    {
