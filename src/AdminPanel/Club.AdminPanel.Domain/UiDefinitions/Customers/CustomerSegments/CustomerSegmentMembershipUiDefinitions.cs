    ...
    public new partial class PublicReport : CRUDDefinition.PublicReport
    {
        ...
        public class SegmentMembersByCountryConfig() : ChartConfigDefinition(ChartType.Bar)
        {
            ...
            protected override void DefineGroupBy()
            {
                ...
                GroupByFormula($"{nameof(CustomerSegmentMembership.CustomerTenant)}.{nameof(CustomerTenant.Country)}.{nameof(Club.Domain.Entities.Geography.Country.Title)}", "کشور");
        ...
        public class SegmentMembersByProvinceConfig() : ChartConfigDefinition(ChartType.Bar)
        {
            ...
            {
                GroupByFormula($"{nameof(CustomerSegmentMembership.Segment)}.{nameof(CustomerSegment.Title)}", "عنوان جامعه/بازار");
                GroupByFormula($"{nameof(CustomerSegmentMembership.CustomerTenant)}.{nameof(CustomerTenant.Province)}.{nameof(Club.Domain.Entities.Geography.Province.Title)}", "استان");
                Count(null, "تعداد اعضا");
            }
        }
        ...
        public class SegmentMembersByCityConfig() : ChartConfigDefinition(ChartType.Bar)
        {
            ...
            {
                GroupByFormula($"{nameof(CustomerSegmentMembership.Segment)}.{nameof(CustomerSegment.Title)}", "عنوان جامعه/بازار");
                GroupByFormula($"{nameof(CustomerSegmentMembership.CustomerTenant)}.{nameof(CustomerTenant.City)}.{nameof(Club.Domain.Entities.Geography.City.Title)}", "شهر");
                Count(null, "تعداد اعضا");
            }
        }
        ...
        public class SegmentMembersIranMapConfig() : ChartConfigDefinition(ChartType.IranMap)
        {
            ...
            {
				GroupByFormula($"{nameof(CustomerSegmentMembership.CustomerTenant)}.{nameof(CustomerTenant.Province)}.{nameof(Club.Domain.Entities.Geography.Province.Title)}", "استان");
				GroupByFormula($"{nameof(CustomerSegmentMembership.CustomerTenant)}.{nameof(CustomerTenant.Province)}.{nameof(Club.Domain.Entities.Geography.Province.Iso2)}", "Iso2");
