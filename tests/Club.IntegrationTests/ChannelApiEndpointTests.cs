...
using Club.Channel.Api.Controllers;
using Club.Channel.Api.Controllers.Dto;
using FluentAssertions;
using Microsoft.AspNetCore.Hosting;
using Microsoft.AspNetCore.Mvc.Testing;
using Microsoft.Extensions.Configuration;
using Program = Club.Channel.Api.Program;

namespace Club.IntegrationTests;
...
public class ChannelApiEndpointTests : IClassFixture<ClubChannelWebApplicationFactory>
{
    ...
    public ChannelApiEndpointTests(ClubChannelWebApplicationFactory factory)
    {
...
public class ClubChannelWebApplicationFactory : WebApplicationFactory<Club.Channel.Api.Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureAppConfiguration((context, config) =>
        {
            ...
            {
                { "ConnectionStrings:Domain", "Server=.;Database=ClubTest;TrustServerCertificate=True" }
            };
